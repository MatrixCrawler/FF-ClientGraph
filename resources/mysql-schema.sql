...
-- Exportiere Struktur von Tabelle freifunk_data.data_timestamp
...
-- Exportiere Struktur von Tabelle freifunk_data.node
...
-- Exportiere Struktur von Tabelle freifunk_data.node_stats
...
CREATE TABLE IF NOT EXISTS `node_stats` (
  ...
  CONSTRAINT `FK_4EECF556460D9FD7` FOREIGN KEY (`node_id`) REFERENCES `node` (`id`),
